...
OUTPUT_FOLDER=outputs/experiment_aurora/pert/brain_topk/pert_cxplain_$DATETIME
...
python perturb_brain.py \
    ...
    --pert.cxplain.trigger-pert-type embedding_trigger_perturbation \
    --pert.cxplain.mask-type sequence \
    --pert.cxplain.batch-size 128 \
    --pert.cxplain.masked_batch_size 1024 \
    --pert.cxplain.trainer-config.model-type unet \
    --pert.cxplain.trainer-config.batch-size 64 \
    --pert.cxplain.trainer-config.epoch 2000 \
    --pert.cxplain.trainer-config.early-stopping-patience 10 \
    --pert.cxplain.trainer-config.learning-rate 1e-3 \
    --pert.cxplain.trainer-config.downsample-factors 4 \
    --pert.cxplain.trainer-config.num-units 1 \
    --pert.cxplain.trainer-config.unet-conv-type 1d \
    ...
    --wandb.name pert_cxplain_$DATETIME \
    --wandb.notes ""