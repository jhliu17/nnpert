...
OUTPUT_FOLDER=outputs/experiment_aurora/pert/brain_topk/pert_lime_$DATETIME
...
python perturb_brain.py \
    --trainer-method lime \
    --pert-target-cell-type Micro\
    --pert-target-gene Dummy \
    --pert-target-gene-file datasets/aurora/topk_expressed_genes/2023-07-31-20-35-40/Micro/Micro_topk_gene_names.txt \
